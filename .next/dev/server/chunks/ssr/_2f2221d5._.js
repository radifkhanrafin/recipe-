...
function IngredientInput({ user, onLogout, onViewSaved, onFindRecipes }) {
    ...
    const handleChange = (e)=>{
        ...
        if (value.trim()) {
            const matches = allIngredients.filter((item)=>item.toLowerCase().includes(value.toLowerCase()) && !ingredients.includes(item.toLowerCase())).slice(0, 5) // show top 5 suggestions
            ;
...
//# sourceMappingURL=_2f2221d5._.js.map