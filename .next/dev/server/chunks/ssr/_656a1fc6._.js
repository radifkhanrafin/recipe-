...
function IngredientInput({ user, onLogout, onViewSaved, onFindRecipes }) {
    ...
    const handleChange = (e)=>{
        ...
        if (value.trim()) {
            const matches = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$recipes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["allIngredients"].filter((item)=>item.toLowerCase().includes(value.toLowerCase()) && !ingredients.includes(item.toLowerCase())).slice(0, 5) // show top 5 suggestions
            ;
...
function RecipeMatch({ onBack, onViewSaved }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (stored) {
            ...
            // Match recipes
            const matches = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$recipes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["recipes"].filter((recipe)=>{
                const matchCount = recipe.ingredients.filter((ing)=>userIngredients.some((userIng)=>ing.toLowerCase().includes(userIng))).length;
